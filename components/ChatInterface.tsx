    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end font-sans">
      ...
      {!isOpen && (
        <button
          ...
          className="group flex items-center gap-3 bg-slate-100 hover:bg-white text-black px-6 py-4 rounded-full shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-all duration-300 transform hover:scale-105"
        >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="w-[90vw] md:w-[400px] h-[500px] bg-black/90 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-fade-in-up">
          {/* Header */}
